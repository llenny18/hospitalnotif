...
<head>
  ...
  <title>Taal RHU System- Manage Medical Records</title>
    ...
    ?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Manage Medical Records</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
             
              <li class="breadcrumb-item" aria-current="page">Manage Medical Records</li>
            </ol>
          </div>
